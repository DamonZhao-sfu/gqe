  ...
  rmm::device_async_resource_ref mr)
{
  ...
  constexpr bool use_de_sort =
    false;  // This flag determines whether or not to sort the chunks before HW
  ...
  switch (comp_format) {
    case gqe::compression_format::lz4: {
      GQE_LOG_TRACE("Creating LZ4 compression manager");
    ...
    case gqe::compression_format::snappy:
      GQE_LOG_TRACE("Creating Snappy compression manager");
    ...
    case gqe::compression_format::ans:
      GQE_LOG_TRACE("Creating ANS compression manager");
    ...
    case gqe::compression_format::cascaded: {
      GQE_LOG_TRACE("Creating Cascaded compression manager");
    ...
    case gqe::compression_format::gdeflate:
      GQE_LOG_TRACE("Creating Gdeflate compression manager");
    ...
    case gqe::compression_format::deflate:
      GQE_LOG_TRACE("Creating Deflate compression manager");
    ...
    case gqe::compression_format::zstd:
      GQE_LOG_TRACE("Creating Zstd compression manager");
    ...
    case gqe::compression_format::bitcomp:
      GQE_LOG_TRACE("Creating Bitcomp compression manager");
      ...
      break;
    default:
      GQE_LOG_ERROR("Unrecognized Compression Format '{}'", gqe::to_string(comp_format));
      break;
  }
  ...
  rmm::device_async_resource_ref mr)
{
  ...
  // Use lock_guard in a scope to serialize CPU batch compression
  {
    ...
    GQE_LOG_TRACE("Using CPU compression manager for batched compression with compression level {}",
