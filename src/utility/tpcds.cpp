...
std::unordered_map<std::string, gqe::utility::table_definition> const& table_definitions() noexcept
{
    ...
    {"store",
     {
       ...
       {{"s_store_sk"}}  // PRIMARY KEY (s_store_sk)
     }},
    {"call_center",
     {
       ...
       {{"cc_call_center_sk"}}  // PRIMARY KEY (cc_call_center_sk)
     }},
    {"catalog_page",
     {
       ...
       {{"cp_catalog_page_sk"}}           // PRIMARY KEY (cp_catalog_page_sk)
     }},
    {"web_site",
     {
       ...
       {{"web_site_sk"}}  // PRIMARY KEY (web_site_sk)
     }},
    {"web_page",
     {
       ...
       {{"wp_web_page_sk"}}  // PRIMARY KEY (wp_web_page_sk)
     }},
    {"warehouse",
     {
       ...
       {{"w_warehouse_sk"}}  // PRIMARY KEY (w_warehouse_sk)
     }},
    {"customer",
     {
       ...
       {{"c_customer_sk"}}                        // PRIMARY KEY (c_customer_sk)
     }},
    {"customer_address",
     {
       ...
       {{"ca_address_sk"}}  // PRIMARY KEY (ca_address_sk)
     }},
    {"customer_demographics",
     {
       ...
       {{"cd_demo_sk"}}  // PRIMARY KEY (cd_demo_sk)
     }},
    {"date_dim",
     {
       ...
       {{"d_date_sk"}}  // PRIMARY KEY (d_date_sk)
     }},
    {"household_demographics",
     {
       ...
       {{"hd_demo_sk"}}  // PRIMARY KEY (hd_demo_sk)
     }},
    {"item",
     {
       ...
       {{"i_item_sk"}}  // PRIMARY KEY (i_item_sk)
     }},
    {"income_band",
     {
       ...
       {{"ib_income_band_sk"}}  // PRIMARY KEY (ib_income_band_sk)
     }},
    {"promotion",
     {
       ...
       {{"p_promo_sk"}}  // PRIMARY KEY (p_promo_sk)
     }},
    {"reason",
     {
       ...
       {{"r_reason_sk"}}  // PRIMARY KEY (r_reason_sk)
     }},
    {"ship_mode",
     {
       ...
       {{"sm_ship_mode_sk"}}  // PRIMARY KEY (sm_ship_mode_sk)
     }},
    {"time_dim",
     {
       ...
       {{"t_time_sk"}}  // PRIMARY KEY (t_time_sk)
     }},
  };
  return definitions;
}
